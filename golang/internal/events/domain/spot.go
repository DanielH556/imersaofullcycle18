...
var (
	...
	ErrNameRequired        = errors.New("spot name is required")
	ErrNameTooShort        = errors.New("spot name must be at least 2 characters long")
	ErrMustStartWithLetter = errors.New("spot name must start with a letter")
	ErrMustEndWithNumber   = errors.New("spot name must end with a number")
)
